...
class WsdlInformationService20 {
  ...
  getBindingOperationName(bindingOperation) {
    return getAttributeByName(bindingOperation, ATRIBUTE_REF).replace(THIS_NS_PREFIX, '');
  }
 ...
 */
   ...
   */
  getPortTypeInterfaceOperationByPortTypeNameAndOperationName(interfaceName, operationName,
