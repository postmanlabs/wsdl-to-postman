...
const Ajv = require('ajv'),
  ...
  BODY_PROPERTY = 'BODY',
  QUERYPARAM_PROPERTY = 'QUERYPARAM',
 ...
 */
  ...
  validateQueryParams({ itemRequestProcessedInfo, operationFromWSDL, options }) {
    ...
    rawItemRequestUrl = itemRequestProcessedInfo.url;
    ...
    if (mimeContentInput && mimeContentInput.mimeType === URL_ENCODED_GET) {
      let childrenParams = operationFromWSDL.input[0].children;
