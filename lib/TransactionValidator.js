...
class TransactionValidator {
      ...
      if (operationFromWSDL) {
        const { protocol, method, name, input } = operationFromWSDL,
          ...
          { responses, responsesMatched } = this.getResponsesValidation(requestItem.response, wsdlObject,
            operationFromWSDL, validateHeadersOption, validationPropertiesToIgnore, ignoreUnresolvedVariables);
   ...
   * @param {Array} validationPropertiesToIgnore option for ignoring properties in validation
   * @param {boolean} ignoreUnresolvedVariables option for ignoring PM unresolved variables
  ...
  getResponsesValidation(responseItem, wsdlObject, operationFromWSDL, validateHeadersOption,
    validationPropertiesToIgnore, ignoreUnresolvedVariables) {
    let responses = {},
  ...
  validateBody(rawXmlMessage, wsdlObject, operationFromWSDL, isResponse, validationPropertiesToIgnore,
    ...
    if (rawXmlMessage) {
      ...
      if (errors.length > 0) {
        let filteredErrors = this.filterSchemaValidationErrors(errors, ignoreUnresolvedVariables);
   ...
   */
  filterSchemaValidationErrors(errors, ignoreUnresolvedVariables) {
