const
  ...
  DOC_HAS_NO_SERVICE_MESSAGE = require('./constants/messageConstants');
class Wsdl11Parser {
  ...
  getServiceURL(servicePort, bindingOperation, bindingTagInfo) {
    ...
    let addressKey = Object.keys(servicePort).find((key) => {
   ...
   */
  getServicePortByBindingName(bindingName, services, principalPrefix, wsdlObject) {
    if (!bindingName) {
