  ...
  assignOperations(wsdlObject, parsedXml) {
    ...
    bindings.forEach((binding) => {
      ...
      bindingOperations.forEach((bindingOperation) => {
        ...
        wsdlOperation.style = this.getStyleFromBindingOperation(bindingOperation, bindingTagInfo);
        ...
        wsdlOperation.url = this.getServiceURL(servicePort, bindingOperation, bindingTagInfo);
