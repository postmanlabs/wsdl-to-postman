...
class Wsdl11Parser {
  ...
  assignOperations(wsdlObject, parsedXml) {
    ...
    bindings.forEach((binding) => {
      ...
      bindingOperations.forEach((operation) => {
        ...
        wsdlOperation.url = this.getServiceURL(servicePort, addressKey, operation, bindingTagInfo);
  ...
  getServiceURL(servicePort, addressKey, bindingOperation, bindingTagInfo) {
