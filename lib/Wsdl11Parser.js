  ...
  assignOperations(wsdlObject, parsedXml) {
    ...
    bindings.forEach((binding) => {
      const bindingTagInfo =
        this.getBindingInfoFromBindinTag(binding,
      ...
      bindingOperations.forEach((operation) => {
        ...
        wsdlOperation.xpathInfo = getOperationxPathInfo(bindingTagInfo.bindingName, wsdlOperation.name,
          wsdlObject.wsdlNamespace.url, WSDL_ROOT);
