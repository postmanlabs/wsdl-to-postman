 ...
 */
  ...
  processBundleFiles(
    ...
    rootFiles.forEach((rootFile, index) => {
      ...
      this.resolveImportsFromRootFile(rootFile, parsedWSDL, parsedSchemas, wsdlRoot, xmlParser.attributePlaceHolder,
        wsdlParser, parsedXMLsAndFileNames, rootFile, wsdlRoot, principalPrefix);
      mergedFiles.push({
        rootFile: {
  ...
  resolveImportsFromRootFile(WSDLRootFile, parsedWSDL, parsedSchemas, wsdlRoot, attributePlaceHolder,
    wsdlParser, parsedXMLsAndFileNames, processingRoot, processingRootTag, rootPrincipalPrefix) {
    let principalPrefix,
      imports,
      parentFolder = '',
      includes;
    ...
    imports = getWSDLImports(processingRoot, principalPrefix, processingRootTag);
    includes = getWSDLIncludes(processingRoot, principalPrefix, processingRootTag);
 ...
 */
   ...
   * @returns {object} undefined
   */
  assignImportedPropertiesSchemaNotTypesTag(root, rootPrincipalPrefix, wsdlRoot, importedTagInformation, schemaPrefix) {
