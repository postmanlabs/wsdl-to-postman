 ...
 */
  ...
  processMergeFiles(filesPathArray, xmlParser, origin = undefined) {
    ...
    this.setReferenceMapSchemas(root, principalPrefix, wsdlRoot, this.resolvedSchemas, xmlParser.attributePlaceHolder);
  ...
  setReferenceMapSchemas(WSDLRootFile, rootPrincipalPrefix, wsdlRoot, resolvedSchemas, attributePlaceHolder) {
    ...
    resolvedSchemas.forEach((resolvedSchema) => {
      ...
      if (Array.isArray(schemasFromType)) {
        ...
        if (found) {
          // verify case when schemas from type exists
            ...
            resolvedSchema.resolvedElements.forEach((resolvedElement) => {
              resolvedElement.elements.forEach((element) => {
                this.setReferenceMap(this.getxPathSchemaElements(rootPrincipalPrefix + wsdlRoot,
                  rootPrincipalPrefix + ATTRIBUTE_TYPES,
                  resolvedSchema.schemaPrefix + SCHEMA_TAG, 0, resolvedElement.tagName,
 ...
 */
  ...
  checkAndMergeSchemas(rootSchema, importedSchema, schemaPrefix, importedTagInformation) {
    ...
    if (willMerge) {
      this.mergeTypesFromImportedToRootSchema(rootSchema, schemaPrefix + COMPLEX_TYPE_TAG,
        ...
        importedTagInformation, COMPLEX_TYPE_TAG);
      this.mergeTypesFromImportedToRootSchema(rootSchema, schemaPrefix + ATTRIBUTE_ELEMENT,
        ...
        importedTagInformation, ATTRIBUTE_ELEMENT);
      this.mergeTypesFromImportedToRootSchema(rootSchema, schemaPrefix + GROUP_TAG,
        ...
        importedTagInformation, GROUP_TAG);
      this.mergeTypesFromImportedToRootSchema(rootSchema, schemaPrefix + SIMPLE_TYPE_TAG,
        ...
        importedTagInformation, SIMPLE_TYPE_TAG);
  ...
  mergeTypesFromImportedToRootSchema(rootSchema, rootPropertyFullName, rootPropertyValue, importedPropertyValue,
    ...
    this.pushResolvedSchemaElType(importedTagInformation, importedPropertyValue, tagType);
  }
