...
/**
 *
 * @description Takes in an input object {data: <string>, type: <string>} and returns
...
function readInput(input) {
  ...
  if (!input.data) {
    ...
    throw new InputError(`Invalid input type (${input.type}). Type must be file/string/folder.`);
  }
  return xml;
}
