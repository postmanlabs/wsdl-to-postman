 ...
 */
getFromInteger = (element) => {
  if (element.minimum) {
    return element.minimum;
  }
  else if (element.maximum) {
    if (element.maximum > 18446744073710) {
...
let knownTypes = {
    ...
    'decimal': getFromNumber,
    'float': getFromNumber,
    'double': getFromNumber,
    'int': getFromInteger,
    'long': getFromInteger,
    'short': getFromInteger,
    'unsignedInt': getFromInteger,
    'unsignedLong': getFromInteger,
    'unsignedShort': getFromInteger,
