    ...
    filtered.forEach((message) => {
      ...
      parts.forEach((part) => {
        ...
        if (realPartTypeorelement) {
          ...
          else if (complexTypes && complexTypes.length > 0) {
          ...
          else if (simpleTypes && simpleTypes.length > 0) {
          ...
          else if (elementsInTypes) {
            let type = elementsInTypes.find((element) => {
              return element.name === realPartTypeorelement;
            });
            if (type) {
