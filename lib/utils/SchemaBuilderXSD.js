...
class SchemaBuilderXSD {
   ...
   * @param {Array} lookedReferences preprocessed references
   * @returns {[Element]} the information of the types
   */
   ...
   * @param {Array} simpleTypes the identified simple types of the wsdl
   * @param {Array} elements preprocessed elements
   * @param {object} contextTraverse context of the traverse function
   * @param {Array} lookedReferences preprocessed references
   * @returns {[Element]} the information of the types
   */
   ...
   * @param {Function} name the function to compare if its a self reference
   * @param {Function} path the function to compare if its a self reference
