 ...
 */
function getOperationxPathInfo(bindingName, operationName, wsdlNamespaceUrl) {
  return {
    xpath: `//pm:definitions//pm:binding[@name="${bindingName}"]//pm:operation[@name="${operationName}"]`,
