...
/**
 * Get the bindings operations of the document
...
/**
 * Finds the namespace looking by its key
 * creates a namespace object with the found information
 * @param {object} parsedXml the binding operation object
...
/**
 * Finds all the namespaces in the document
...
/**
 * Finds all the services in the document
 * creates a namespace array object with the found information
 * @param {object} parsedXml the binding operation object
 * @param {string} wsdlRoot the root tag for the document
...
/**
 * Get the bindings in the document
 * always returns an array
 * @param {object} parsedXml the binding operation object
 * @param {string} wsdlRoot the root tag for the document
...
/**
 * if the element is an object then the parser populated
